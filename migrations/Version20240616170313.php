 ...
 */
final class Version20240616170313 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE emprunt (id INT AUTO_INCREMENT NOT NULL, adherent_id INT DEFAULT NULL, exemplaire_id INT DEFAULT NULL, date_emprunt DATETIME NOT NULL, date_retour DATETIME DEFAULT NULL, statut TINYINT(1) NOT NULL, INDEX IDX_364071D725F06C53 (adherent_id), INDEX IDX_364071D75843AA21 (exemplaire_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
